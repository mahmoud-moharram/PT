<div class="card-body">
    <div class="breadcrumb-line header-elements-md-inline  border-bottom border-2">
        <div class="d-flex h-flex">
            <div class="breadcrumb mb-1">
                ...
                <span class="breadcrumb-item active">Sqlmap</span>
            </div>
    ...
    <div class="row justify-content-center mt-2">
        <div class="col-md-12">
            <div class=" w-100">
                @include('livewire.sqlmap.create')
            </div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        @if(!is_null($row->result))
                            <a href="{{ route('pt.sqlmap.show',$row->id) }}" target="_blank" class="btn btn-primary btn-sm mr-2"><i class="fas fa-eye"></i></a>
                        @endif
